...
* [Latest Stable Release](https://github.com/pkgforge-dev/Audio-Sharing-AppImage/releases/latest)
...
* [AM](https://github.com/ivan-hc/AM) `am -i audio-sharing` or `appman -i audio-sharing`

* [dbin](https://github.com/xplshn/dbin) `dbin install audio-sharing.appimage`

* [soar](https://github.com/pkgforge/soar) `soar install audio-sharing`
